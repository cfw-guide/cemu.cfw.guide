...
1. Once this is finished, optionally select `Friends List` and press the **(A)** button again
...
1. On your SD card, navigate to `dumpling/online_files/vol/storage_mlc01`
1. Copy and paste this to your Cemu mlc01 folder
  - Overwrite any files if prompted
1. If you dumped the `Friends List` title, copy the contents of `dumpling/friends_list/sys/title/00050030` to your Cemu games directory
